...
public partial class ViewGeneratorGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var pipeline = context.SyntaxProvider.ForAttributeWithMetadataName(
            fullyQualifiedMetadataName: typeof(GenerateViewAttribute).FullName,
    ...
    private static void ExecuteEmitReactiveObject(SourceProductionContext context, EquatableArray<ViewResult> sources)
    {
